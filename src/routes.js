...
const Roles = React.lazy(() => import('./containers/Apps/Roles/RolesContainer'));
const Historys = React.lazy(() => import('./containers/Apps/Historys/HistorysContainer'));
const Locations = React.lazy(() => import('./containers/Apps/Locations/LocationsContainer'));
//Apps_end
